...
class CustomerPortalsSelectors:
    ...
    full_portals_list = (By.CSS_SELECTOR, 'div.cv-portal-cards-react-container')
    portal_from_list = (By.CSS_SELECTOR, 'div[data-testid="portal-card-item"]')
...
class CustomerPortalSelectors:
    ...
    description_wysiwyg_field = (By.CSS_SELECTOR, 'div.wysiwyg-create-request div[contenteditable]')
...
class RequestSelectors:
    ...
    comment_request_field = (By.CSS_SELECTOR, 'textarea#comment-on-request')
    comment_request_wysiwyg_field = (By.CSS_SELECTOR, 'div.wysiwyg-comment div[contenteditable]')
